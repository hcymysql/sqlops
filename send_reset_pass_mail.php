...
system("./mail/sendEmail -f sqlops@126.com -t {$useremail} -s smtp.126.com -u '你的密码找回信' -o message-charset=utf8 -o message-content-type=html -m '请在10分钟内重置密码，过期链接失效。请不要把这个链接告诉别人，你懂的！</br></br><a href='http://sqlops.xxx.com/sqlops_approve/resetUserPass.php?p={$String}'>确认密码找回</a>' -xu sqlops@126.com  -xp 'uGSacaObzf14o957'  ");
