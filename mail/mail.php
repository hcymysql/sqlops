...
class mail{
	...
	function noticeReply(){
		system("./mail/sendEmail -f chunyang_he@126.com -t {$this->dev_user_mail} -cc chunyang_he@126.com -s smtp.126.com:25 -u '工单号：{$this->order_id} 已经完成审批，请执行SQL.' -o message-charset=utf8 -o message-content-type=html -m '工单号：{$this->order_id} <br>工单名称：{$this->sql_order}  <br>请登录<a href='http://sqlops.xxx.com/sqlops_approve/'>SQL自动审核平台</a>执行SQL！' -xu chunyang_he@126.com -xp '123456' -o tls=no");
	}
}
